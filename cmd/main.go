...
import (
	...
	"github.com/eryalito/kubensync-operator/internal/controller"
...
func main() {
	...
	opts := zap.Options{}
	flag.BoolVar(&opts.Development, "zap-development", false, "Enable development mode for zap logger")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "07c33303.kubensync.com",
	...
	if err = (&controller.NamespaceController{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
